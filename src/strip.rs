...
//     pub struct LedController<SPI, const N: usize> {
//         leds: [Color; N],
//         _spi: PhantomData<SPI>,
//     }

//     impl<SPI, const N: usize> LedController<SPI, N> {
//         pub fn new() -> Self {
//             Self {
...
//     impl<SPI, const N: usize> Strip for LedController<SPI, N> {
...
//     impl<SPI, const N: usize> Debug for LedController<SPI, N> {
